...
import ru.vysokikh.project.dto.CategoryParentUpdateDto;
import ru.vysokikh.project.exceptions.CategoryValidator;
...
public class CategoryController {
    ...
    public String insertCategoryPage(Model model) {
        CategoryParentUpdateDto categoryParentUpdateDto = new CategoryParentUpdateDto(0, "", "", null);
    ...
    public String insertCategoryChildPage(Model model) {
        CategoryParentUpdateDto categoryParentUpdateDto = new CategoryParentUpdateDto(0, "", "", 0L);
    ...
    public String insertNewCategoryChild(
            @Valid @ModelAttribute("insertCategoryChild") CategoryParentUpdateDto categoryParentUpdateDto,
