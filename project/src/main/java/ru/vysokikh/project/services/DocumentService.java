...
public interface DocumentService {
    ...
    Document insert(String docname, String docauthor, String docyear, String docsource, String dockeyword,
                            Date docdateinput, String docannotation, long categoryId, long typeDocumentId,
                            long pathSavePdfId);

    Document updateDocument(long docid, String docname, String docauthor, String docyear, String docsource,
