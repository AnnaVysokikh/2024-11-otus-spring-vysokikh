...
public class DBChangelog {
    ...
    @ChangeSet(order = "001", id = "dropDb", author = "user", runAlways = true)
    public void dropDb(MongoDatabase db) {
        db.drop();
    }

    @ChangeSet(order = "002", id = "initAuthors", author = "user", runAlways = true)
    ...
    @ChangeSet(order = "003", id = "initGenres", author = "user", runAlways = true)
    ...
    @ChangeSet(order = "004", id = "Book", author = "user", runAlways = true)
    ...
    @ChangeSet(order = "005", id = "Comment", author = "user", runAlways = true)
